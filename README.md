**注意: これはTurboWarpのカスタム拡張機能ではありません**  
# NekoDevTools
...
```js
javascript:(function(){if(window.NDT){return} const s=document.createElement('script');s.src='https://nyantorusabu.github.io/NDT/NekoDevTools.js';document.body.appendChild(s)})();
```  
